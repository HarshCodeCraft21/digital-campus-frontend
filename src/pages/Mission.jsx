    ...
    <div className="min-h-screen bg-base-200">
      ...
      <section className="container mx-auto px-4 py-16 bg-base-200">
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-20">
          {/* Our Vision Card */}
          <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all rounded-2xl border-l-[6px] border-primary">
            <div className="card-body">
              ...
              <p className="text-base-content/70 leading-relaxed">
                ...
                We envision a future where quality education is a right, not a privilege—accessible
                to all, regardless of geography or background.
              </p>
            </div>
          </div>

          {/* Our Mission Card */}
          <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all rounded-2xl border-l-[6px] border-secondary">
            <div className="card-body">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {/* Accessibility Card */}
            <div className="card bg-base-100 shadow-md hover:shadow-lg transition-all rounded-2xl">
        ...
        {/* Stats Section */}
        <div className="bg-gradient-to-r from-blue-500 to-orange-400 rounded-2xl p-12 mt-20 max-w-5xl mx-auto text-white shadow-xl"> <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center"> <div> <div className="text-4xl font-extrabold mb-1">10K+</div> <div className="text-sm opacity-90">Students</div> </div> <div> <div className="text-4xl font-extrabold mb-1">500+</div> <div className="text-sm opacity-90">Courses</div> </div> <div> <div className="text-4xl font-extrabold mb-1">200+</div> <div className="text-sm opacity-90">Instructors</div> </div> <div> <div className="text-4xl font-extrabold mb-1">50+</div> <div className="text-sm opacity-90">Countries</div> </div> </div> </div>
      </section>
    </div>
  );
}
