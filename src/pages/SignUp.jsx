        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 py-12">
            <div className="card w-full max-w-2xl bg-white shadow-lg">
                <div className="card-body">
                    ...
                    <p className="text-center text-gray-500 mb-6">Join Digital Campus and start your learning journey</p>

                    <form onSubmit={handleSubmit} className="space-y-4">
                        {/* Profile Image */}
                        <div className="flex flex-col items-center gap-4">
                            <div className="relative">
                                <div className="w-24 h-24 rounded-full bg-gray-200 overflow-hidden border-2 border-primary/20">
                                    {imagePreview ? (
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full rounded-xl text-white font-medium py-2 transition-colors
    bg-blue-500 hover:bg-blue-600
    disabled:bg-blue-300 disabled:cursor-not-allowed disabled:hover:bg-blue-400
  `}
                        >
